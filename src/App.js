...
import { NewDasboard } from './components/dashboard/Dashboard';

import { Mensagens } from './components/mensagens/Mensagens';
import { MensagensEnviadas } from './components/mensagens/MensagensEnviadas';
...
class App extends Component {
    ...
    createMenu() {
        this.menu = [
            {
                label: 'Novo Dashboard', icon: 'pi pi-fw pi-star', command: () => {
                    window.location = '#/new-dashboard'
                }
            },
            {
                label: 'Mensagens', icon: 'pi pi-fw pi-envelope',
                items: [
                    {
                        label: 'Enviadas', icon: 'pi pi-fw pi-upload', command: () => {
                            window.location = '#/mensagens-enviadas'
                        }
                    },
                    {
                        label: 'Recebidas', icon: 'pi pi-fw pi-download', command: () => {
        ...
        return (
            <div className={ wrapperClass } onClick={ this.onWrapperClick }>
                ...
                <div className="layout-main">
                    ...
                    <Route path="/new-dashboard" component={ NewDasboard }/>
